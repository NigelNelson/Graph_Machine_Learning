...
experiment_name = '8layer_8head_Do30_GAT'
...
class GAT(torch.nn.Module):
    def __init__(self, feature_dim, hidden_dim, num_classes):
        ...
        self.gat2 = GATv2Conv(hidden_dim*heads, hidden_dim, heads, dropout=0.3)
        self.gat3 = GATv2Conv(hidden_dim*heads, hidden_dim, heads)
        self.gat4 = GATv2Conv(hidden_dim*heads, hidden_dim, heads, dropout=0.3)
        self.gat5 = GATv2Conv(hidden_dim*heads, hidden_dim, heads)
        self.gat6 = GATv2Conv(hidden_dim*heads, hidden_dim, heads, dropout=0.3)

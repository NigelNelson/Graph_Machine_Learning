...
experiment_name = '8layer_8head_Do50_GAT'
...
class GAT(torch.nn.Module):
    def __init__(self, feature_dim, hidden_dim, num_classes):
        ...
        self.gat2 = GATv2Conv(hidden_dim*heads, hidden_dim, heads, dropout=0.5)
        self.gat3 = GATv2Conv(hidden_dim*heads, hidden_dim, heads)
        self.gat4 = GATv2Conv(hidden_dim*heads, hidden_dim, heads, dropout=0.5)
        self.gat5 = GATv2Conv(hidden_dim*heads, hidden_dim, heads)
        self.gat6 = GATv2Conv(hidden_dim*heads, hidden_dim, heads, dropout=0.5)
...
def eval(model, data_loader):
    ...
    for data in data_loader:  # Iterate in batches over the training/test dataset.
        ...
        precision, recall, F1, _ = precision_recall_fscore_support(y.cpu(), pred.cpu(), average='micro')

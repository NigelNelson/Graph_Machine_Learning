...
experiment_name = '4layer_Do30_STconv'
...
class STGCN(torch.nn.Module):
    def __init__(self, feature_dim, hidden_dim, num_classes):
        ...
        self.stconv1 = st_gcn(hidden_dim, hidden_dim, kernel_size, 1, 0.3)
        self.stconv2 = st_gcn(hidden_dim, hidden_dim, kernel_size, 1, 0.3)
